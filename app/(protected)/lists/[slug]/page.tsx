...
import { getOwnerLists, rebuildPublicLibrary, saveOwnerList } from '@/lib/firebase/publicSharing'
...
export default function OwnerListPage({ params }: { params: { slug: string } }) {
  ...
  const [customFolder, setCustomFolder] = useState<OwnerListDocument | null>(null)
  ...
  async function saveSnapshot() {
    ...
    try {
      ...
      if (profile.publicUsername) await rebuildPublicLibrary(user.uid, entries, nextProfile)
